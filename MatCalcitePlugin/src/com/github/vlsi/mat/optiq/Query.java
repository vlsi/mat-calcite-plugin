...
public class Query implements IQuery {
	...
	public static final Pattern RENAME_INDEX = Pattern.compile("EnumerableTableAccessRel\\(table=\\[\\[HEAP, \\$ids\\$:([^]]+)\\]\\]\\)");
	public static final Pattern RENAME_JOIN = Pattern.compile("EnumerableJoinRel");
	public static final Pattern RENAME_CALC = Pattern.compile("EnumerableCalcRel");
